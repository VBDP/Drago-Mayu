Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1d55d5076efe361428bf4c9999719e74"
{
	Properties
	{
		...
		_EmissionStrength_Glowstick ("Emission Strength", Range(0, 20)) = 0
		...
		[VectorLabel(Min, Max)]_EmissionAL0Multipliers_Glowstick ("Multiplier", Vector) = (1, 1, 0, 0)
		...
		[VectorLabel(Min, Max)]_EmissionAL0StrengthMod_Glowstick ("Strength", Vector) = (0, 0, 0, 0)
		...
		[ToggleUI] _AudioLinkAnimToggle_Glowstick ("Anim Toggle", Float) = 1
		[ThryHeaderLabel(Smoothing)]
		_AudioLinkSmoothingBass_Glowstick ("Bass", Range(0, 1)) = 0
		_AudioLinkSmoothingLowMid_Glowstick ("Low Mid", Range(0, 1)) = 0
		_AudioLinkSmoothingHighMid_Glowstick ("High Mid", Range(0, 1)) = 0
		_AudioLinkSmoothingTreble_Glowstick ("Treble", Range(0, 1)) = 0
		...
		_ALDecaldCircleDimensions_Glowstick ("Cirlce Dimensions--{ condition_showS:_ALDecalUVMode==1}", Vector) = (0, 1, 0, 1)
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _AudioLinkAnimToggle_Glowstick;
			float _AudioLinkSmoothingBass_Glowstick;
			float _AudioLinkSmoothingLowMid_Glowstick;
			float _AudioLinkSmoothingHighMid_Glowstick;
			float _AudioLinkSmoothingTreble_Glowstick;
			...
			float4 _ALDecaldCircleDimensions_Glowstick;
			...
			float _EmissionStrength_Glowstick;
			...
			float2 _EmissionAL0StrengthMod_Glowstick;
			...
			float2 _EmissionAL0Multipliers_Glowstick;
			...
			{
				if (!_AudioLinkAnimToggle_Glowstick) return;
				if (AudioLinkIsAvailable())
				{
					poiMods.audioLinkAvailable = true;
					poiMods.audioLinkVersion = AudioLinkGetVersion();
					poiMods.audioLink[0] = _AudioLinkSmoothingBass_Glowstick == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 0))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - _AudioLinkSmoothingBass_Glowstick) * 15.95, 0))[0];
					poiMods.audioLink[1] = _AudioLinkSmoothingLowMid_Glowstick == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 1))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - _AudioLinkSmoothingLowMid_Glowstick) * 15.95, 1))[0];
					poiMods.audioLink[2] = _AudioLinkSmoothingHighMid_Glowstick == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 2))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - _AudioLinkSmoothingHighMid_Glowstick) * 15.95, 2))[0];
					poiMods.audioLink[3] = _AudioLinkSmoothingTreble_Glowstick == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 3))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - _AudioLinkSmoothingTreble_Glowstick) * 15.95, 3))[0];
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.75 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.25 /*_Shadow2ndBorder*/), (0.5 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.125 /*_Shadow3rdBorder*/), (0.25 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.75 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.75 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.25 /*_Shadow2ndBorder*/), (0.5 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.125 /*_Shadow3rdBorder*/), (0.25 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.75 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.7254258,0.7254258,0.7254258,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.7254258,0.7254258,0.7254258,1).rgb;
				}
				if (float4(0.5600193,0.5600193,0.5600193,0).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.5600193,0.5600193,0.5600193,0).rgb;
					lns.y = float4(0.5600193,0.5600193,0.5600193,0).a - lns.y * float4(0.5600193,0.5600193,0.5600193,0).a;
					indirectColor = lerp(indirectColor, shadow2ndColorTex.rgb, lns.y);
				}
				if (float4(0.1887741,0.1887741,0.1887741,0).a > 0)
				{
					#if defined(PROP_SHADOW3RDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(0.1887741,0.1887741,0.1887741,0).rgb;
					lns.z = float4(0.1887741,0.1887741,0.1887741,0).a - lns.z * float4(0.1887741,0.1887741,0.1887741,0).a;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcapIntensity = (2.0 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.55 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_ALDecalUVMode*/) == 1)
				{
					maskY = remap(maskY, _ALDecaldCircleDimensions_Glowstick.x, _ALDecaldCircleDimensions_Glowstick.y, 0, 1);
				}
				float maskX = aluv.x;
				if ((1.0 /*_ALDecalUVMode*/) == 1)
				{
					maskX = remap(maskX, _ALDecaldCircleDimensions_Glowstick.z, _ALDecaldCircleDimensions_Glowstick.w, 0, 1);
				}
				...
				float3 emissionColor = lerp(lowColor * (0.0 /*_ALDecalLowEmission*/), midColor * (1.0 /*_ALDecalMidEmission*/), saturate(volumeColorSrc * 2));
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = _EmissionStrength_Glowstick;
				float3 emissionColor0 = 0;
				applyALEmmissionStrength(poiMods, emissionStrength0, _EmissionAL0StrengthMod_Glowstick, (0.0 /*_EmissionAL0StrengthBand*/), _EmissionAL0Multipliers_Glowstick, (2.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.0 /*_AudioLinkEmission0CenterOutSize*/), (3.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL0Enabled*/), (0.25 /*_AudioLinkEmission0CenterOutDuration*/));
				...
				emissionColor0 = hueShift(emissionColor0, frac((0.0 /*_EmissionHueShift*/) + (2.0 /*_EmissionHueShiftSpeed*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled*/), (0.0 /*_EmissionHueShiftColorSpace*/));
