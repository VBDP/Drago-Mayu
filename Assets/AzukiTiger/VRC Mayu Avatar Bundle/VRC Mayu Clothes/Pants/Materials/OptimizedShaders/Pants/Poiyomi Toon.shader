Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/4337afdef834be6439a14d5e3a50e16d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (2.0 /*_MatcapUVMode*/), (0.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.4 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (1.0 /*_MatcapNormal*/), matcapALD);
				...
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (1.0 /*_Matcap2UVMode*/), (0.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.5 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.8 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.6 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (7.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
