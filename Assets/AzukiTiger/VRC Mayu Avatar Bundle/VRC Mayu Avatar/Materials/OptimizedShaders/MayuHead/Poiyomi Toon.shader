Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/ac7a3ca80d20b8548acf37af1b1b6905"
{
	Properties
	{
		...
		_DecalColor_Head ("Color--{reference_property:_DecalColorThemeIndex}", Color) = (1, 1, 1, 1)
		...
		_DecalBlendAlpha_Head ("Alpha", Range(0, 1)) = 1
		...
		_DecalEmissionStrength1_Head ("Emission Strength", Range(0, 20)) = 0
		...
		_DecalBlendAlpha1_Head ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha2_Head ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalEmissionStrength1_Head;
			float _DecalBlendAlpha1_Head;
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(1.0 /*_DetailNormalMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_DetailNormalMapStochastic*/)), (1.0 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			struct PoiDecal
			{
				...
				void SampleDecalNoTexture(in PoiMods poiMods, in PoiLight poiLight, in PoiMesh poiMesh, in PoiCam poiCam)
				{
					...
					decalColor = float4(poiThemeColor(poiMods, m_DecalColor_Head.rgb, m_DecalColorThemeIndex), m_DecalColor_Head.a);
				...
				void SampleDecal(sampler2D decalTexture, in PoiMods poiMods, in PoiLight poiLight, in PoiMesh poiMesh, in PoiCam poiCam, float2 scaleMultiplier = float2(1, 1))
				{
					...
					decalColor = tex2D(decalTexture, poiUV(uv, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduv.xy, dduv.zw) * float4(poiThemeColor(poiMods, m_DecalColor_Head.rgb, m_DecalColorThemeIndex), m_DecalColor_Head.a);
					decalColor.rgb = decalHueShift(m_DecalHueShiftEnabled, decalColor.rgb, m_DecalHueShift + poiLight.nDotV * m_DecalHueAngleStrength, m_DecalHueShiftSpeed, m_DecalHueShiftColorSpace);
					decalColor.a *= decalMask[m_DecalMaskChannel] * applyTilingClipping(m_DecalTiled, uv);
				}
				void SampleDecalNoAlpha(sampler2D decalTexture, in PoiMods poiMods, in PoiLight poiLight, in PoiMesh poiMesh, in PoiCam poiCam, float2 scaleMultiplier = float2(1, 1))
				{
					uv = decalUV(m_DecalTextureUV, m_DecalPosition, m_DecalRotation + decalRotation, m_DecalRotationSpeed, decalScale * scaleMultiplier, m_DecalSideOffset +sideMod, m_DecalDepth, m_DecalSymmetryMode, m_DecalMirroredUVMode, poiMesh, poiCam);
					float4 dduv = any(fwidth(uv) > .5) ? 0.001 : float4(ddx(uv) * m_DecalTexture_ST.x, ddy(uv) * m_DecalTexture_ST.y);
					decalColor.rgb = tex2D(decalTexture, poiUV(uv, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduv.xy, dduv.zw) * float4(poiThemeColor(poiMods, m_DecalColor_Head.rgb, m_DecalColorThemeIndex), m_DecalColor_Head.a).rgb;
					decalColor.rgb = decalHueShift(m_DecalHueShiftEnabled, decalColor.rgb, m_DecalHueShift + poiLight.nDotV * m_DecalHueAngleStrength, m_DecalHueShiftSpeed, m_DecalHueShiftColorSpace);
					decalColor.a *= decalMask[m_DecalMaskChannel] * applyTilingClipping(m_DecalTiled, uv);
				}
				...
				void SampleDecalChannelSeparation(sampler2D decalTexture, in PoiMods poiMods, in PoiLight poiLight, in PoiMesh poiMesh, in PoiCam poiCam)
				{
					...
					float4 sample0 = tex2D(decalTexture, poiUV(uvSample0, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduvSample0.xy, dduvSample0.zw) * float4(poiThemeColor(poiMods, m_DecalColor_Head.rgb, m_DecalColorThemeIndex), m_DecalColor_Head.a);
					float4 sample1 = tex2D(decalTexture, poiUV(uvSample1, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduvSample1.xy, dduvSample1.zw) * float4(poiThemeColor(poiMods, m_DecalColor_Head.rgb, m_DecalColorThemeIndex), m_DecalColor_Head.a);
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Head + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColor_Head = _DecalColor_Head;
				...
				Decal0.m_DecalRotationSpeed = (1.0 /*_DecalRotationSpeed*/);
				Decal0.m_DecalEmissionStrength = (0.0 /*_DecalEmissionStrength*/);
				Decal0.m_DecalBlendAlpha_Head = _DecalBlendAlpha_Head;
				...
				Decal1.m_DecalRotationSpeed = (0.05 /*_DecalRotationSpeed1*/);
				Decal1.m_DecalEmissionStrength = _DecalEmissionStrength1_Head;
				Decal1.m_DecalBlendAlpha_Head = _DecalBlendAlpha1_Head;
				...
				Decal2.m_DecalColor_Head = float4(1,1,1,1);
				...
				Decal2.m_DecalBlendAlpha_Head = _DecalBlendAlpha2_Head;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (0.0 /*_Matcap2UVMode*/), (0.0 /*_Matcap2UVToBlend*/), float4(0.5,0.5,0,0).xy, (1.0 /*_Matcap2Rotation*/), (0.43 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				...
				#if defined(PROP_MATCAP4) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (0.0 /*_Matcap4UVMode*/), (1.0 /*_Matcap4UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap4Rotation*/), (0.43 /*_Matcap4Border*/), normal3, poiCam, poiLight, poiMesh, (1.0 /*_Matcap4Normal*/), matcapALD);
				...
				matcap4.rgb = lerp(matcap4.rgb, matcap4.rgb * poiFragData.baseColor.rgb, (0.8 /*_Matcap4BaseColorMix*/));
				#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.2 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (0.8 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (3.0 /*_Matcap4MaskGlobalMask*/), (0.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
