Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/da35dd4bb05943e43a9afa556da801d2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(0,0,0.01444384,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(0,0,0.01444384,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
				poiFragData.baseColor.rgb *= LerpWhiteTo(detailTexture * (1.0 /*_DetailBrightness*/) * unity_ColorSpaceDouble.rgb, poiMods.detailMask.r * (0.6 /*_DetailTexIntensity*/));
			}
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				lightMap.y *= lerp(1.0, shadowAttenuationNoStrength, (0.8 /*_Shadow2ndReceive*/));
				lightMap.z *= lerp(1.0, shadowAttenuationNoStrength, (0.6 /*_Shadow3rdReceive*/));
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.8 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.3 /*_Shadow2ndBorder*/), (0.6 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.15 /*_Shadow3rdBorder*/), (0.4 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.8 /*_ShadowBlur*/) * blurMap.r, (1.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.8 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.3 /*_Shadow2ndBorder*/), (0.6 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.15 /*_Shadow3rdBorder*/), (0.4 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.8 /*_ShadowBlur*/) * blurMap.r, (1.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.3613069,0.1432046,0.3613069,0.2509804).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.3613069,0.1432046,0.3613069,0.2509804).rgb;
					lns.y = float4(0.3613069,0.1432046,0.3613069,0.2509804).a - lns.y * float4(0.3613069,0.1432046,0.3613069,0.2509804).a;
					indirectColor = lerp(indirectColor, shadow2ndColorTex.rgb, lns.y);
				}
				if (float4(0.05846914,0.05846914,0.1274377,0.5019608).a > 0)
				{
					#if defined(PROP_SHADOW3RDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(0.05846914,0.05846914,0.1274377,0.5019608).rgb;
					lns.z = float4(0.05846914,0.05846914,0.1274377,0.5019608).a - lns.z * float4(0.05846914,0.05846914,0.1274377,0.5019608).a;
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(0,0,0.01444384,1).rgb * float4(0,0,0.01444384,1).a);
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							vertexLighting = max(vertexLighting,lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.1 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.4 /*_LightingAdditiveGradientStart*/), (0.6 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow);
						}
					}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (1.0 /*_MatcapMixed*/), (1.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.5 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (7.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (2.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.43 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				...
				matcap2.rgb = lerp(matcap2.rgb, matcap2.rgb * poiFragData.baseColor.rgb, (0.5 /*_Matcap2BaseColorMix*/));
				#if defined(PROP_MATCAP2MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (1.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (7.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				...
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (2.0 /*_Matcap3UVMode*/), (1.0 /*_Matcap3UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap3Rotation*/), (0.43 /*_Matcap3Border*/), normal2, poiCam, poiLight, poiMesh, (1.0 /*_Matcap3Normal*/), matcapALD);
				#if defined(PROP_MATCAP3) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				matcapIntensity = (0.8 /*_Matcap3Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.5 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.0 /*_Matcap3Multiply*/), (0.0 /*_Matcap3Replace*/), (1.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (1.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float reflectionMask = (0.5 /*_ClearCoatReflectionStrength*/);
