Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/0408e7ed3159bb74eb86c794fbc9563c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.5600193,0.3165999,0,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5600193,0.3165999,0,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.5600193,0.3165999,0,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5600193,0.3165999,0,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.5600193,0.3165999,0,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5600193,0.3165999,0,1).a);
				#endif
