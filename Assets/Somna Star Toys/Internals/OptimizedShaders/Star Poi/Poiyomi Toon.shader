Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/0a99d29b23de4064cb79868da934d5ea"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0,0,0), 0.0, float4(0,2,0,0), 0.0, 0.0);
